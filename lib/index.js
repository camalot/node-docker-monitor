...
module.exports = function (mhandler, dockerOpts, opts) {
	console.log(mhandler.onContainerUp);
	console.log(mhandler.onContainerDown);
	console.log(mhandler.onError);
	console.log(mhandler.onUpdateComplete);
	console.log(mhandler.onMonitorStarted);
	console.log(mhandler.onMonitorStopped);
