...
interface EventHandler {
	...
	onUpdateComplete(containers?: Map, docker?: Dockerode);
	onError(err?: Error, docker?: Dockerode);
}

interface MonitorFunction {
	(
		handler: EventHandler,
		dockerOpts?: DockerodeOptions | Dockerode,
		opts?: Options /* { strategy: 'monitorAll', selectorLabel: 'node-docker-monitor' } */
	): Monitor;
}
